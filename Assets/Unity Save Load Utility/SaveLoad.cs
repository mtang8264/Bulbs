...
public static class SaveLoad {
	...
	public static void SaveScene(SaveGame saveGame, string saveGamePath) {
		...
		FileStream file = File.Create (saveGamePath + saveGame.savegameName + ".bulb"); //you can call it anything you want including the file extension
	...
	public static SaveGame LoadScene(string gameToLoad, string saveGamePath) {
		...
		if(File.Exists(saveGamePath + gameToLoad + ".bulb")) {
			...
			FileStream file = File.Open(saveGamePath + gameToLoad + ".bulb", FileMode.Open);
	...
	public static List<SaveGame> GetSaveGames(string path, bool usePersistentDataPath) {
		...
		List<FileInfo> info = dir.GetFiles("*.bulb", SearchOption.AllDirectories).ToList();
	...
	public static void DeleteFile(string path, string fileName) {
		if(File.Exists(path + fileName + ".bulb")) {
			File.Delete(path + fileName + ".bulb");
		}
	}
}
